...
export default function AdminOverviewPage() {
  return (
    <div>
      ...
      <p className="mt-2 text-gray-400">Manage events, registrations, and memberships.</p>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-400">Create, edit, and delete events.</p>
        </Link>
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-400">View all ticket holders per event.</p>
        </Link>
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-400">View and manage member accounts.</p>
        </Link>
      </div>
    </div>
  );
