    ...
    const fetchRequests = async () => {
        if (!user) return;
        try {
        const res = await fetch(`/api/admin/membership-requests?userId=${user.id}`);
    ...
    return (
        ...
        <p className="mt-2 text-gray-400">Review payment screenshots and verify or reject requests.</p>
